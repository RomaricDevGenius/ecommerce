                                    ...
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col pr-1">
                                                    <input type="number" class="form-control" name="length" value="0.00" step="0.01" placeholder="{{ translate('Length') }}">
                                                </div>
                                                <div class="col px-1">
                                                    <input type="number" class="form-control" name="breadth" value="0.00" step="0.01" placeholder="{{ translate('Width') }}">
                                                </div>
                                                <div class="col pl-1">
...
<style>
/* Alignement des radio buttons avec les catégories */
#treeview li {
    display: flex;
    align-items: center;
    margin-bottom: 5px;
