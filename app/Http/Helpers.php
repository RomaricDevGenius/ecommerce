...
function get_french_translations_fallback()
{
    return [
        ...
        // Formulaire de paiement Moov Money (web)
        'enter_your_moov_money_phone_number_you_will_receive_an_otp_code_by_sms_to_confirm_the_payment' => 'Saisissez votre numéro Moov Money. Vous recevrez un code OTP par SMS pour confirmer le paiement.',
        'moov_money_phone_number' => 'Numéro Moov Money',
        '8_digits_no_spaces_or_dashes' => '8 chiffres, sans espaces ni tirets',
        'receive_otp_code' => 'Recevoir le code OTP',
        'otp_code_sent_to' => 'Code OTP envoyé au',
        'valid_for_10_minutes' => 'Valable 10 minutes.',
        ...
        // Email template types (colonne "Type d'e-mail" dans la liste des templates)
        'delivery_boy_registration' => 'Inscription livreur',
        'delivery_boy_registration_by_admin' => 'Inscription livreur par l\'admin',
        'customer_registration_by_admin' => 'Inscription client par l\'admin',
        'seller_own_account_registration' => 'Inscription vendeur (propre compte)',
        'seller_registration_by_admin' => 'Inscription vendeur par l\'admin',
        ...
        'refund_request_accepted_by_admin' => 'Remboursement accepté par l\'admin',
        'refund_request_accepted_by_seller' => 'Remboursement accepté par le vendeur',
        'refund_request_accepted' => 'Remboursement accepté',
        'refund_request_denied_by_admin' => 'Remboursement refusé par l\'admin',
        'refund_request_denied_by_seller' => 'Remboursement refusé par le vendeur',
        'refund_request_denied' => 'Remboursement refusé',
        'seller_payout_request' => 'Demande de retrait vendeur',
        'payout_request' => 'Demande de retrait',
        'payout_received' => 'Retrait reçu',
        'email_verification_for_registration' => 'Vérification e-mail (inscription)',
        'wallet_recharge_confirmation' => 'Recharge de portefeuille',
        'email_update_verification' => 'Vérification mise à jour e-mail',
        'verification_code_for_email_update' => 'Code de vérification (mise à jour e-mail)',
        'verification_code_for_email_update_verification' => 'Code de vérification (mise à jour e-mail)',
        'seller_shop_approval' => 'Approbation de boutique vendeur',
        // Email template subjects (stored in DB, displayed via translate())
        'new_customer_registration_customer_name' => 'Nouvelle inscription client - [[customer_name]]',
        'new_seller_registration_shop_name' => 'Nouvelle inscription vendeur - [[shop_name]]',
        'new_delivery_boy_registration_store_name' => 'Nouvelle inscription livreur - [[store_name]]',
        'a_new_order_order_code_has_been_placed' => 'Une nouvelle commande [[order_code]] a été passée !',
        'new_order_confirmed_order_code' => 'Nouvelle commande confirmée - [[order_code]]',
        'order_placed_order_code' => 'Commande passée - [[order_code]]',
        'order_cancelled_order_code' => 'Commande annulée - [[order_code]]',
        'order_delivered_order_code' => 'Commande livrée - [[order_code]]',
        'order_on_the_way_order_code' => 'Commande en route - [[order_code]]',
        'order_picked_up_order_code' => 'Commande ramassée - [[order_code]]',
        'your_order_order_code_has_been_placed_successfully' => 'Votre commande [[order_code]] a été passée avec succès !',
        'your_order_order_code_has_been_cancelled' => 'Votre commande [[order_code]] a été annulée !',
        'your_order_order_code_has_been_on_the_way' => 'Votre commande [[order_code]] est en route !',
        'your_order_order_code_has_been_picked_up' => 'Votre commande [[order_code]] a été ramassée !',
        'your_order_order_code_is_delivered' => 'Votre commande [[order_code]] a été livrée !',
        'your_order_order_code_has_been_confirmed' => 'Votre commande [[order_code]] a été confirmée !',
        'password_reset_store_name' => 'Réinitialisation du mot de passe - [[store_name]]',
        'confirm_your_email_to_complete_your_registration_at_store_name' => 'Confirmez votre e-mail pour finaliser votre inscription sur [[store_name]]',
        'verify_your_email_to_activate_your_seller_account_at_store_name' => 'Vérifiez votre e-mail pour activer votre compte vendeur sur [[store_name]]',
        'welcome_to_store_name' => 'Bienvenue sur [[store_name]]',
        'welcome_to_store_name_delivery_team' => 'Bienvenue dans l\'équipe de livraison [[store_name]] !',
        'payment_confirmation_from_store_name' => 'Confirmation de paiement de [[store_name]]',
        'payment_received_for_order_order_code' => 'Paiement reçu pour la commande [[order_code]]',
        'payout_request_received_at_store_name' => 'Demande de retrait reçue sur [[store_name]]',
        'seller_payment_processed_shop_name' => 'Paiement vendeur traité - [[shop_name]]',
        'seller_payout_request_shop_name' => 'Demande de retrait vendeur - [[shop_name]]',
        'new_refund_request_for_order_order_code' => 'Nouvelle demande de remboursement pour la commande [[order_code]]',
        'refund_accepted_for_order_order_code' => 'Remboursement accepté pour la commande [[order_code]]',
        'refund_request_accepted_for_order_order_code' => 'Demande de remboursement acceptée pour la commande [[order_code]]',
        'refund_request_denied_for_order_order_code' => 'Demande de remboursement refusée pour la commande [[order_code]]',
        'refund_request_denied_by_seller_shop_name_for_order_order_code' => 'Demande de remboursement refusée par [[shop_name]] pour la commande [[order_code]]',
        'refund_request_for_order_order_code_has_been_accepted_by_shop_name' => 'La demande de remboursement pour [[order_code]] a été acceptée par [[shop_name]]',
        'refund_request_received_for_order_order_code' => 'Demande de remboursement reçue pour la commande [[order_code]]',
        ...
        // Assignation dynamique — admin configuration
        'dynamic_assignment'              => 'Assignation dynamique',
        'assignment_mode'                 => 'Mode d\'assignation',
        'manual'                          => 'Manuel',
        'dynamic_autobroadcast'           => 'Dynamique (diffusion auto)',
        'dynamic_orders_are_automatically_broadcast_to_nearby_delivery_boys' => 'Dynamique : les commandes sont diffusées automatiquement aux livreurs à proximité.',
        'broadcast_radius_km'             => 'Rayon de diffusion (km)',
        'search_radius_to_find_available_delivery_boys' => 'Rayon de recherche pour trouver les livreurs disponibles.',
        'offer_timeout_seconds'           => 'Délai d\'acceptation (secondes)',
        'time_a_delivery_boy_has_to_accept_before_the_offer_expires' => 'Temps dont dispose un livreur pour accepter avant l\'expiration de l\'offre.',
        ...
        'maintenance_mode_activation' => 'Activation du mode maintenance',
        'disable_image_encoding' => 'Désactiver l\'encodage des images ?',
        'business_related' => 'Paramètres commerciaux',
        'vendor_system_activation' => 'Activation du système vendeurs',
        'classified_product' => 'Produit classé',
        'wallet_system_activation' => 'Activation du portefeuille',
        'coupon_system_activation' => 'Activation des coupons',
        'pickup_point_activation' => 'Activation des points de retrait',
        'conversation_activation' => 'Activation de la messagerie',
        'seller_product_manage_by_admin' => 'Produits vendeur gérés par l\'admin',
        'after_activate_this_option_cash_on_delivery_of_seller_product_will_be_managed_by_admin' => 'Après activation, le paiement à la livraison des produits vendeurs sera géré par l\'admin.',
        'admin_approval_on_seller_product' => 'Approbation admin sur les produits vendeurs',
        'after_activate_this_option_admin_approval_need_to_seller_product' => 'Après activation, l\'approbation admin est requise pour les produits vendeurs.',
        'email_verification' => 'Vérification par e-mail',
        'you_need_to_configure_smtp_correctly_to_enable_this_feature' => 'Vous devez configurer SMTP correctement pour activer cette fonctionnalité.',
        'product_query_activation' => 'Activation des questions produits',
        'product_external_link_for_seller' => 'Lien externe produit pour vendeurs',
        'use_floating_buttons_in_website' => 'Utiliser les boutons flottants sur le site',
        'last_viewed_products_activation' => 'Activation des derniers produits vus',
        'newsletter_activation' => 'Activation de la newsletter',
        'wholesale_product_for_seller' => 'Produits en gros pour vendeurs',
        'auction_product_for_seller' => 'Produits aux enchères pour vendeurs',
        'guest_checkout_activation' => 'Activation du paiement invité',
        'seller_registration_verification' => 'Vérification d\'inscription vendeur',
        'customer_registration_verification' => 'Vérification d\'inscription client',
        'digital_product_for_seller' => 'Produit numérique pour vendeurs',
        'after_activating_this_option_sellers_can_add_digital_products' => 'Après activation, les vendeurs pourront ajouter des produits numériques.',
        'billing_address_required' => 'Adresse de facturation requise',
        'billing_address_required_for_checkout' => 'Adresse de facturation requise lors du paiement.',
        'social_media_login' => 'Connexion via réseaux sociaux',
        'facebook_login' => 'Connexion Facebook',
        'you_need_to_configure_facebook_client_correctly_to_enable_this_feature' => 'Configurez correctement le client Facebook pour activer cette fonctionnalité.',
        'google_login' => 'Connexion Google',
        'you_need_to_configure_google_client_correctly_to_enable_this_feature' => 'Configurez correctement le client Google pour activer cette fonctionnalité.',
        'twitter_login' => 'Connexion Twitter',
        'you_need_to_configure_twitter_client_correctly_to_enable_this_feature' => 'Configurez correctement le client Twitter pour activer cette fonctionnalité.',
        'apple_login' => 'Connexion Apple',
        'you_need_to_configure_apple_client_correctly_to_enable_this_feature' => 'Configurez correctement le client Apple pour activer cette fonctionnalité.',
        'settings_updated_successfully' => 'Paramètres mis à jour avec succès',

        // Paramètres commerciaux
        'business_settings' => 'Paramètres commerciaux',
        'gstin_number' => 'Numéro GSTIN',
        'gstin_certificate' => 'Certificat GSTIN',
        'view_current_certificate' => 'Voir le certificat actuel',
        'vat_tin_bin_number' => 'Numéro TVA / TIN / BIN',
        'reg_certificate_trade_license_sale_tax_permit' => 'Certificat / Licence commerciale / Permis de taxe de vente',
        'select_your_country' => 'Sélectionnez votre pays',
        'file_preview' => 'Aperçu du fichier',

        // Zones & livraison
        'area_information' => 'Informations de la zone',
        'all_areas' => 'Toutes les zones',
        'area' => 'Zone',
        'type_area_name_enter' => 'Saisir le nom de la zone & Entrée',
        'area_wise_shipping_cost' => 'Coût d\'expédition par zone',
        'show_hide' => 'Afficher/Masquer',
        'add_new_area' => 'Ajouter une nouvelle zone',
        'area_status_updated_successfully' => 'Statut de la zone mis à jour avec succès',
        'all_zones' => 'Toutes les zones de livraison',
        'add_new_zone' => 'Ajouter une nouvelle zone',
        'zone_information' => 'Informations de la zone',
        'zone_name' => 'Nom de la zone',

        // Boîtes d'expédition
        'add_new_box_size' => 'Ajouter une taille de boîte',
        'search_box_sizes' => 'Rechercher les tailles de boîtes...',
        'box_size_information' => 'Informations sur la taille de la boîte',
        'edit_box_size_information' => 'Modifier les informations de la boîte',
        'set_courier_type' => 'Définir le type de transporteur',
        'box_length_cm' => 'Longueur de la boîte (cm)',
        'box_breadth_cm' => 'Largeur de la boîte (cm)',
        'box_height_cm' => 'Hauteur de la boîte (cm)',
        'please_select_at_least_one_shipping_box_size' => 'Veuillez sélectionner au moins une taille de boîte d\'expédition',
        'are_you_sure_you_want_to_delete_the_selected_shipping_box_sizes' => 'Voulez-vous vraiment supprimer les tailles de boîtes sélectionnées ?',
        'are_you_sure_you_want_to_delete_the_selected_shipping_box_size' => 'Voulez-vous vraiment supprimer cette taille de boîte ?',
        ...
        'set_currency_formats' => 'Définir les formats de devise',
        'symbol_format' => 'Format du symbole',
        'decimal_separator' => 'Séparateur décimal',
        'no_of_decimals' => 'Nombre de décimales',
        ...
        'all_rates_are_relative_to_1_usd_example_usd_1_eur_092_1_usd_092_fcfa_600_1_usd_600_fcfa_your_product_prices_are_in_the_default_currency_the_site_converts_them_using_these_rates' => 'Tous les taux sont relatifs à 1 USD. Exemple : EUR = 0,92 ; FCFA = 600. Les prix sont dans la devise par défaut et convertis automatiquement.',
        'currency_status_updated_successfully' => 'Statut de la devise mis à jour avec succès',

        // Pays / États / Villes
        'countries' => 'Pays',
        'type_country_name' => 'Saisir le nom du pays',
        'country_status_updated_successfully' => 'Statut du pays mis à jour avec succès',
        'if_you_disable_a_country_all_associated_states_cities_and_areas_under_that_country_will_also_be_automatically_disabled' => 'Désactiver un pays désactive automatiquement ses États, villes et zones.',
        'all_cities' => 'Toutes les villes',
        'cities' => 'Villes',
        'type_city_name_enter' => 'Saisir le nom de la ville & Entrée',
        'add_new_city' => 'Ajouter une nouvelle ville',
        'city_information' => 'Informations de la ville',
        'city_status_updated_successfully' => 'Statut de la ville mis à jour avec succès',
        'if_you_disable_a_city_all_associated_areas_under_that_city_will_also_be_automatically_disabled' => 'Désactiver une ville désactive automatiquement ses zones.',
        'all_states' => 'Tous les États',
        'states' => 'États',
        'type_state_name' => 'Saisir le nom de l\'État',
        'add_new_state' => 'Ajouter un nouvel État',
        'state_status_updated_successfully' => 'Statut de l\'État mis à jour avec succès',
        'if_you_disable_a_state_all_associated_cities_and_areas_under_that_state_will_also_be_automatically_disabled' => 'Désactiver un État désactive automatiquement ses villes et zones.',
        'action' => 'Action',

        // Transporteurs
        'all_carriers' => 'Tous les transporteurs',
        'add_new_carrier' => 'Ajouter un transporteur',
        'carriers' => 'Transporteurs',
        'carrier_information' => 'Informations du transporteur',
        'carrier_informations' => 'Informations du transporteur',
        'carrier_name' => 'Nom du transporteur',
        'transit_time' => 'Délai de transit',
        'transit_name' => 'Nom du transit',
        'free_shipping' => 'Livraison gratuite',
        'billing_type' => 'Type de facturation',
        'according_to_weight' => 'Selon le poids',
        'according_to_price' => 'Selon le prix',
        'add_new_range' => 'Ajouter une plage',
        'update_carrier_informations' => 'Mettre à jour les informations du transporteur',
        'weight_based_carrier_price_range' => 'Plage de prix par poids',
        'price_based_carrier_price_range' => 'Plage de prix par montant',
        'will_be_applied_when_the_weight_is' => 'Sera appliqué quand le poids est',
        'will_be_applied_when_the_price_is' => 'Sera appliqué quand le prix est',
        'carrier_status_updated_successfully' => 'Statut du transporteur mis à jour avec succès',
        'carrier_status_went_wrong' => 'Erreur lors de la mise à jour du statut du transporteur',

        // Méthodes de paiement
        'cash_payment' => 'Paiement en espèces',
        'payment_settings_updated_successfully' => 'Paramètres de paiement mis à jour avec succès',
        'moov_money_merchant_id' => 'Identifiant marchand Moov Money',
        'moov_money_merchant_password' => 'Mot de passe marchand Moov Money',
        'moov_otp_api_url' => 'URL API OTP Moov',
        'uat' => 'UAT',
        'moov_money_sandbox_mode' => 'Mode sandbox Moov Money',
        'orange_money_merchant_id' => 'Identifiant marchand Orange Money',
        'orange_money_merchant_number' => 'Numéro marchand Orange Money',
        'orange_money_merchant_password' => 'Mot de passe marchand Orange Money',
        'orange_money_sandbox_mode' => 'Mode sandbox Orange Money',
        'merchant_id' => 'Identifiant marchand',
        'merchant_number' => 'Numéro marchand',
        'merchant_password' => 'Mot de passe marchand',
        'country_phone_code_codepays' => 'Code téléphonique du pays (codePays)',
        'when_sandbox_is_on_the_test_base_url_will_be_used' => 'Quand le sandbox est activé, l\'URL de test sera utilisée.',
        'stripe_secret' => 'Clé secrète Stripe',

        // Points de retrait
        'all_pick_up_points' => 'Tous les points de retrait',
        'add_new_pick_up_point' => 'Ajouter un point de retrait',
        'pick_up_points' => 'Points de retrait',
        'manager' => 'Responsable',
        'pickup_station_contact' => 'Contact de la station de retrait',
        'no_manager' => 'Aucun responsable',
        'pickup_point_information' => 'Informations du point de retrait',
        'update_pickup_point_information' => 'Mettre à jour le point de retrait',
        'pickup_point_status' => 'Statut du point de retrait',
        'pick_up_point_manager' => 'Responsable du point de retrait',
        'pickup_point' => 'Point de retrait',

        // Taxes
        'all_taxes' => 'Toutes les taxes',
        'add_new_tax' => 'Ajouter une taxe',
        'tax_type' => 'Type de taxe',
        'tax_name' => 'Nom de la taxe',
        'tax_status_updated_successfully' => 'Statut de la taxe mis à jour avec succès',
        'tax_information' => 'Informations de la taxe',
        'update_tax_info' => 'Mettre à jour les informations de la taxe',

        // Montant minimum de commande
        'minimum_order_amount_settings' => 'Paramètres du montant minimum de commande',
        'minimum_order_amount_check' => 'Vérification du montant minimum de commande',
        ...
        'test_smtp_configuration' => 'Tester la configuration SMTP',
        'enter_your_email_address' => 'Saisir votre adresse e-mail',
        'send_test_email' => 'Envoyer un e-mail de test',
        'instruction' => 'Instructions',
        'please_be_carefull_when_you_are_configuring_smtp_for_incorrect_configuration_you_will_get_error_at_the_time_of_order_place_new_registration_sending_newsletter' => 'Une mauvaise configuration SMTP provoquera des erreurs lors des commandes, inscriptions et newsletters.',
        'for_non_ssl' => 'Pour Non-SSL',
        'select_sendmail_for_mail_driver_if_you_face_any_issue_after_configuring_smtp_as_mail_driver' => 'Sélectionnez Sendmail si vous rencontrez des problèmes avec SMTP.',
        'set_mail_host_according_to_your_server_mail_client_manual_settings' => 'Configurez l\'hôte selon les paramètres manuels de votre serveur.',
        'set_mail_port_as_587' => 'Définir le port sur 587',
        'set_mail_encryption_as_ssl_if_you_face_issue_with_tls' => 'Définissez le chiffrement sur ssl si vous rencontrez des problèmes avec tls.',
        'for_ssl' => 'Pour SSL',
        'set_mail_port_as_465' => 'Définir le port sur 465',
        'set_mail_encryption_as_ssl' => 'Définissez le chiffrement sur ssl',

        // Système de fichiers
        's3_file_system_credentials' => 'Identifiants S3',
        'backblaze_file_system_credentials' => 'Identifiants Backblaze',
        'aws_s3_file_system_activation' => 'Activation du système de fichiers AWS S3',
        'backblaze_file_system_activation' => 'Activation du système de fichiers Backblaze',
        'local_file_system_activation' => 'Activation du système de fichiers local',
        'cache_session_driver' => 'Pilote de cache et de session',
        'redis_configuration_if_you_use_redis_as_any_of_the_drivers' => 'Configuration Redis (si vous utilisez Redis comme pilote)',
        'file_system_can_not_activate_without_configuration' => 'Le système de fichiers ne peut pas être activé sans configuration.',

        // Google / Facebook / Analytics
        'google_recaptcha_setting' => 'Paramètres reCAPTCHA Google',
        'site_key' => 'Clé du site',
        'secret_key' => 'Clé secrète',
        'select_score' => 'Sélectionner un score',
        'google_recaptcha_v3_returns_a_score_ranging_from_00_to_10_that_indicates_the_likelihood_a_request_is_made_by_a_human_or_a_bot' => 'Google reCAPTCHA v3 retourne un score de 0,0 à 1,0 indiquant si la requête provient d\'un humain ou d\'un bot.',
        'how_to_interpret_the_recaptcha_v3_scores' => 'Comment interpréter les scores reCAPTCHA V3',
        'google_map_setting' => 'Paramètres de Google Maps',
        'google_map_configuration_notes' => 'Notes de configuration Google Maps',
        'enable_google_map' => 'Activer Google Maps',
        'set_the_google_map_api_key' => 'Définir la clé API Google Maps.',
        'after_then_you_will_find_the_google_map_option_to_set_default_location' => 'Vous trouverez ensuite l\'option pour définir la position par défaut.',
        'default_location_setting' => 'Paramètre de localisation par défaut',
        'google_firebase_setting' => 'Paramètres Firebase Google',
        'facebook_pixel_setting' => 'Paramètres Facebook Pixel',
        'facebook_pixel' => 'Facebook Pixel',
        'facebook_pixel_id' => 'Identifiant Facebook Pixel',
        'please_be_carefull_when_you_are_configuring_facebook_pixel' => 'Soyez prudent lors de la configuration de Facebook Pixel.',
        'log_in_to_facebook_and_go_to_your_ads_manager_account' => 'Connectez-vous à Facebook et accédez à votre Ads Manager.',
        'open_the_navigation_bar_and_select_events_manager' => 'Ouvrez la barre de navigation et sélectionnez Gestionnaire d\'événements.',
        'copy_your_pixel_id_from_underneath_your_site_name_and_paste_the_number_into_facebook_pixel_id_field' => 'Copiez votre Pixel ID et collez-le dans le champ Pixel ID.',
        'google_analytics_setting' => 'Paramètres Google Analytics',
        'tracking_id' => 'Identifiant de suivi',
        'facebook_comment_setting' => 'Paramètres des commentaires Facebook',
        'facebook_app_id' => 'Identifiant d\'application Facebook',
        'please_be_carefull_when_you_are_configuring_facebook_comment_for_incorrect_configuration_you_will_not_get_comment_section_on_your_user_end_site' => 'Une mauvaise config des commentaires Facebook supprimera la section commentaires.',
        'login_into_your_facebook_page' => 'Connectez-vous à votre page Facebook',
        'after_then_go_to_this_url_httpsdevelopersfacebookcomapps' => 'Ensuite, allez sur developers.facebook.com/apps/',
        'create_your_app' => 'Créez votre application',
        'in_dashboard_page_you_will_get_your_app_id' => 'Dans le tableau de bord, vous trouverez votre App ID',
        'facebook_chat_setting' => 'Paramètres du chat Facebook',
        'facebook_page_id' => 'Identifiant de page Facebook',
        'please_be_carefull_when_you_are_configuring_facebook_chat_for_incorrect_configuration_you_will_not_get_messenger_icon_on_your_user_end_site' => 'Une mauvaise config du chat Facebook supprimera l\'icône Messenger.',
        'find_the_about_option_of_your_facebook_page' => 'Trouvez la section « À propos » de votre page Facebook.',
        'at_the_very_bottom_you_can_find_the_facebook_page_id' => 'Tout en bas, vous trouverez le « Facebook Page ID ».',
        'set_your_website_domain_name' => 'Définissez le nom de domaine de votre site.',

        // WhatsApp
        'whatsapp_chat_setting' => 'Paramètres du chat WhatsApp',
        'whatsapp_order' => 'Commande WhatsApp',
        'for_seller_products' => 'Pour les produits vendeurs',
        'get_whatsapp_order_for_seller_products' => 'Recevoir les commandes WhatsApp pour les produits vendeurs',
        'order_message' => 'Message de commande',
        'whatsapp_number' => 'Numéro WhatsApp',

        // Configuration de l'expédition
        'select_shipping_method' => 'Sélectionner la méthode d\'expédition',
        'go_to_shipping_configuration_page' => 'Aller à la page de configuration d\'expédition',
        'area_wise_shipping_cost_desc' => 'Tarif fixe par zone. Le coût est calculé selon la zone du client.',
        'product_wise_shipping_cost' => 'Frais d\'expédition par produit',
        'shipping_cost_is_calculated_by_adding_the_shipping_cost_of_each_product' => 'Les frais d\'expédition sont calculés en additionnant le coût de chaque produit.',
        'flat_rate_shipping_cost' => 'Tarif fixe d\'expédition',
        'shipping_cost_stays_the_same_no_matter_how_many_products_are_purchased' => 'Le tarif reste le même quel que soit le nombre de produits achetés.',
        'seller_wise_shipping_cost' => 'Frais d\'expédition par vendeur',
        'a_fixed_rate_is_set_for_each_seller_if_a_customer_buys_products_from_two_sellers_the_total_shipping_cost_is_the_sum_of_each_sellers_rate' => 'Un tarif fixe est défini par vendeur. Si un client achète chez deux vendeurs, le total est la somme des deux tarifs.',
        'carrier_wise_shipping_cost' => 'Frais d\'expédition par transporteur',
        'shipping_cost_calculate_in_addition_with_carrier_in_each_carrier_you_can_set_free_shipping_cost_or_can_set_weight_range_or_price_range_shipping_cost' => 'Les frais sont calculés avec le transporteur. Chaque transporteur peut avoir une livraison gratuite ou des plages poids/prix.',
        'frais_par_distance_gps' => 'Frais par distance GPS',
        'frais_calcules_selon_la_distance_reelle_entre_le_point_de_retrait_et_le_client_paliers_configurables_surcharge_poidsvolume' => 'Frais calculés selon la distance réelle. Paliers configurables + surcharge poids/volume.',
        'set_shipping_method' => 'Définir la méthode d\'expédition',
        'you_have_selected_product_wise_shipping_cost' => 'Vous avez sélectionné les frais par produit',
        'you_have_selected_flat_rate_shipping_cost' => 'Vous avez sélectionné le tarif fixe',
        'you_have_selected_seller_wise_flat_shipping_cost' => 'Vous avez sélectionné le tarif fixe par vendeur',
        'you_have_selected_area_wise_flat_shipping_cost' => 'Vous avez sélectionné le tarif fixe par zone',
        'you_have_selected_carrier_wise_shipping_cost' => 'Vous avez sélectionné les frais par transporteur',
        'for_area_wise_shipping_cost_you_need_to_configure_the_complete_location_hierarchy' => 'Pour les frais par zone, configurez la hiérarchie complète : Pays → État → Ville → Zone.',
        'do_you_want_to_enable_states' => 'Voulez-vous activer les États ?',
        'each_seller_has_a_fixed_shipping_rate_admin_can_set_their_rate_here_and_sellers_set_theirs_from_their_panel' => 'Chaque vendeur a un tarif fixe. L\'admin peut le définir ici, et les vendeurs depuis leur espace.',
        'shipping_carriers' => 'Transporteurs d\'expédition',
        'state_enabled_successfully' => 'État activé avec succès',
        'state_disabled_successfully' => 'État désactivé avec succès',
        'shipping_configuration' => 'Configuration d\'expédition',
        'shipping_box_size_configuration' => 'Configuration des tailles de boîtes',

        // GPS / livraison par distance
        'depuis_km' => 'Depuis (km)',
        'frais_fcfa' => 'Frais (FCFA)',
        'revision_manuelle' => 'Révision manuelle',
        'parametres_poids_volume' => 'Paramètres poids & volume',
        'mode_de_calcul' => 'Mode de calcul',
        'poids_uniquement' => 'Poids uniquement',
        'poids_volume' => 'Poids + Volume',
        'poids_inclus_kg' => 'Poids inclus (kg)',
        'poids_inclus_gratuitement_dans_le_tarif_de_base' => 'Poids inclus gratuitement dans le tarif de base.',
        'surcharge_par_kg_en_plus' => 'Surcharge par kg en plus',
        'volume_inclus_litres' => 'Volume inclus (litres)',
        'surcharge_par_litre_en_plus' => 'Surcharge par litre en plus',
        'paliers_de_distance' => 'Paliers de distance',
        'distance' => 'Distance',
        'tarif_de_base' => 'Tarif de base',
        'ajouter' => 'Ajouter',
        'modifier' => 'Modifier',
        'supprimer_ce_palier' => 'Supprimer ce palier ?',
        'supprimer' => 'Supprimer',
        'aucun_palier_defini' => 'Aucun palier défini.',
        'devis_gps_en_attente' => 'Devis GPS en attente',
        'ajouter_un_palier' => 'Ajouter un palier',
        'annuler' => 'Annuler',
        'configurer' => 'Configurer',

        // Système / mise à jour
        'update_your_system' => 'Mettre à jour votre système',
        'current_verion' => 'Version actuelle',
        'current_version' => 'Version actuelle',
        'make_sure_your_server_has_matched_with_all_requirements' => 'Assurez-vous que votre serveur remplit toutes les exigences.',
        'download_latest_version_from_codecanyon' => 'Téléchargez la dernière version depuis CodeCanyon.',
        'extract_downloaded_zip_you_will_find_updates_zip_file_in_those_extraced_files' => 'Extrayez le zip téléchargé. Vous trouverez le fichier updates.zip.',
        'upload_that_zip_file_here_and_click_update_now' => 'Téléversez ce fichier zip ici et cliquez sur Mettre à jour.',
        'if_you_are_using_any_addon_make_sure_to_update_those_addons_after_updating' => 'Si vous utilisez des modules, mettez-les à jour après la mise à jour principale.',
        'please_turn_off_maintenance_mode_before_updating' => 'Veuillez désactiver le mode maintenance avant de mettre à jour.',
        'you_can_autometically_update_from_previous_10_ten_version' => 'Vous pouvez mettre à jour automatiquement depuis les 10 versions précédentes.',
        'if_you_dont_have_system_key' => 'Si vous n\'avez pas de clé système',
        'update_now' => 'Mettre à jour maintenant',
        'import_demo_data' => 'Importer les données de démonstration',
        'it_may_take_some_times_to_upload_so_do_not_close_the_browser_or_tab' => 'Cela peut prendre du temps, ne fermez pas le navigateur ou l\'onglet.',
        'if_you_have_previous_data_then_it_may_conflicts_with_some_of_your_current_data' => 'Si vous avez des données existantes, il peut y avoir des conflits.',
        'make_sure_you_have_activated_your_system_with_the_domain_and_site_url' => 'Assurez-vous d\'avoir activé votre système avec le domaine et l\'URL du site.',
        'domain_name' => 'Nom de domaine',
        'codecanyon_purchase_code' => 'Code d\'achat CodeCanyon',
        'domain_name_example_abcdcom' => 'Nom de domaine (exemple : abcd.com)',
        'site_url_example_httpsabcdcom_or_httpswwwabcdcom' => 'URL du site (exemple : https://abcd.com ou https://www.abcd.com)',
        'server_information' => 'Informations serveur',
        'required_version' => 'Version requise',
        'phpini_config' => 'Configuration php.ini',
        'config_name' => 'Nom de la configuration',
        'recommended' => 'Recommandé',
        'extensions_information' => 'Informations sur les extensions',
        'extension_name' => 'Nom de l\'extension',
        'filesystem_permissions' => 'Permissions du système de fichiers',
        'file_or_folder' => 'Fichier ou dossier',
        'sitemap_generator' => 'Générateur de sitemap',
        'generate_and_download' => 'Générer et télécharger',
        'sitemap_generation_history' => 'Historique de génération du sitemap',
        ...
        'addon_manager' => 'Gestionnaire de modules',

        // Navigation admin (éléments non encore traduits)
        'add_new_product_2' => 'Ajouter un nouveau produit',
        'add_new_preorder_products_2' => 'Ajouter des produits en précommande',
        'orders_preorder_2' => 'Commandes (Précommande)',
        'offline_payment_system' => 'Paiement hors ligne',
        'manual_payment_methods' => 'Méthodes de paiement manuelles',
        'offline_payment_orders' => 'Commandes paiement hors ligne',
        'offline_wallet_recharge' => 'Recharge portefeuille hors ligne',
        'offline_seller_package_payments' => 'Paiements de forfaits vendeurs hors ligne',
        'knet_payment_gateway' => 'Passerelle Knet',
        'cybersource_payment_gateway' => 'Passerelle Cybersource',
        'asian_payment_gateway' => 'Passerelle paiement asiatique',
        'african_payment_gateway' => 'Passerelle paiement africaine',
        'gst_system' => 'Système GST',
        'unverified_sellers' => 'Vendeurs non vérifiés',
        'hsn_assign' => 'Attribution HSN',
        'sms_templates' => 'Modèles SMS',
        'otp_login_configuration' => 'Configuration connexion OTP',
        'otp_configurations' => 'Configurations OTP',
        'club_point_configurations' => 'Configuration des points de fidélité',
        'set_product_point' => 'Définir les points produits',
        'user_points' => 'Points utilisateurs',
        'affiliate_registration_form' => 'Formulaire d\'affiliation',
        'affiliate_configurations' => 'Configurations d\'affiliation',
        'affiliate_users' => 'Utilisateurs affiliés',
        'referral_users' => 'Utilisateurs référents',
        'affiliate_withdraw_requests' => 'Demandes de retrait affiliés',
        'affiliate_logs' => 'Journaux d\'affiliation',
        'shiprocket' => 'Shiprocket',
        'steadfast' => 'Steadfast',
        'pathao' => 'Pathao',
        'select_homepage' => 'Sélectionner la page d\'accueil',
        'font_family' => 'Famille de police',
        'authentication_layout_settings' => 'Mise en page & Paramètres d\'authentification',
        'element' => 'Élément',
        'all_elements' => 'Tous les éléments',
        'select_header' => 'Sélectionner l\'en-tête',
        'header_settings' => 'Paramètres de l\'en-tête',
        'top_bar' => 'Barre supérieure',
        'top_bar_list' => 'Liste barre supérieure',
        'top_bar_settings' => 'Paramètres barre supérieure',
        'footer_settings' => 'Paramètres du pied de page',
        'appearance' => 'Apparence',
        'landing_page_setup' => 'Configuration page d\'accueil',
        'header_nav' => 'Navigation en-tête',
        'landing_page' => 'Page d\'accueil',
        'features_activation' => 'Activation des fonctionnalités',
        'vat_tax' => 'TVA & Taxes',
        'social_media_logins' => 'Connexions sociales',
        'analytics_tools' => 'Outils d\'analyse',
        'select_shipping_method_nav' => 'Sélectionner la méthode d\'expédition',
        ...
        'warranty_text' => 'Texte de garantie',
        'warranty_logo' => 'Logo de garantie',
        'add_new_warranty' => 'Ajouter une garantie',
        'minimum_dimensions_required_40px_width_x_40px_height' => 'Dimensions minimales requises : 40px × 40px.',

        // Import marques en masse
        'brand_bulk_upload' => 'Importation en masse de marques',
        'step_1' => 'Étape 1',
        'download_the_skeleton_file_and_fill_it_with_proper_data' => 'Téléchargez le fichier modèle et remplissez-le avec les données appropriées.',
        'you_can_download_the_example_file_to_understand_how_the_data_must_be_filled' => 'Téléchargez le fichier exemple pour comprendre comment renseigner les données.',
        'once_you_have_downloaded_and_filled_the_skeleton_file_upload_it_in_the_form_below_and_submit' => 'Une fois le fichier rempli, importez-le via le formulaire ci-dessous et soumettez.',
        'download_csv' => 'Télécharger le CSV',
        'upload_brand_file' => 'Importer le fichier de marques',
        'upload_csv' => 'Importer le CSV',

        // Remboursement par catégorie
        'set_category_wise_product_refund' => 'Définir le remboursement produit par catégorie',
        'category_based_refund_is_not_activated_active' => 'Le remboursement par catégorie n\'est pas activé. Activer',
        'seller_products' => 'Produits vendeurs',
        'refund_request_timedays' => 'Délai de demande de remboursement (jours)',
        'category_based_refund_is_not_enabled' => 'Le remboursement par catégorie n\'est pas activé.',
        'set' => 'Définir',
        'nb_if_you_set_a_refund_time_here_all_the_sub_categories_under_this_category_will_follow_the_same_refund_period_you_can_still_set_refund_periods_individually_for_sub_categories_later_do_you_want_to_continue' => 'N.B : Si vous définissez un délai ici, toutes les sous-catégories suivront la même période. Voulez-vous continuer ?',
        'please_enter_a_valid_refund_time_1_or_more_days' => 'Veuillez saisir un délai de remboursement valide (1 jour ou plus).',
        'saving' => 'Enregistrement...',
        'an_error_occurred' => 'Une erreur s\'est produite.',

        // Remise par catégorie
        'set_category_wise_product_discount' => 'Définir la remise produit par catégorie',
        'present_discount' => 'Remise actuelle',
        'discount_date_range' => 'Plage de dates de la remise',
        'discount' => 'Remise',
        'discount_can_not_be_less_than_0' => 'La remise ne peut pas être inférieure à 0.',
        'category_wise_product_discount_set_successfully' => 'Remise produit par catégorie définie avec succès.',

        // Marques
        'brand_logo' => 'Logo de la marque',
        'products_of_this_brand' => 'Produits de cette marque',
        ...
        'are_you_sure_you_want_to_delete_the_selected_brands' => 'Êtes-vous sûr de vouloir supprimer les marques sélectionnées ?',
        'associated_products_will_be_affected_once_deleted_the_brands_and_products_will_be_permanently_removed' => 'Les produits associés seront affectés. Une fois supprimées, les marques et produits seront définitivement retirés.',
        'are_you_sure_you_want_to_delete_the_selected_brand' => 'Êtes-vous sûr de vouloir supprimer la marque sélectionnée ?',
        'associated_products_will_be_affected_once_deleted_the_brand_and_product_will_be_permanently_removed' => 'Les produits associés seront affectés. Une fois supprimée, la marque et le produit seront définitivement retirés.',
        'failed_to_load_data' => 'Échec du chargement des données.',
        'failed_to_load_brand_details_data' => 'Échec du chargement des détails de la marque.',
        'please_select_at_least_one_brand' => 'Veuillez sélectionner au moins une marque.',
        'selected_brands_deleted_successfully' => 'Marques sélectionnées supprimées avec succès.',
        ...
        // Produit / numérique
        'tags' => 'Étiquettes',
        'type_to_add_a_tag' => 'Saisir pour ajouter une étiquette',
        'images' => 'Images',
        'main_images' => 'Images principales',
        'thumbnail_image' => 'Image miniature',
        'meta_tags' => 'Balises méta',
        'keywords' => 'Mots-clés',
        'keyword_keyword' => 'Mot-clé, Mot-clé',
        ...
        'product_thumb' => 'Miniature du produit',
        'category_not_found' => 'Catégorie non trouvée',
        'select_a_category' => 'Sélectionner une catégorie',
        'select_main' => 'Sélectionner principale',
        'this_will_be_used_for_commission_based_calculations_and_homepage_category_wise_product_show' => 'Utilisé pour les calculs de commissions et l\'affichage par catégorie en page d\'accueil.',
        'update_product' => 'Mettre à jour le produit',
        'variant_price' => 'Prix de la variante',
        'sku' => 'Référence (SKU)',
        'clear_tempdata' => 'Effacer les données temporaires',
        'general' => 'Général',
        'product_information' => 'Informations sur le produit',
        'save_product' => 'Enregistrer le produit',
        'add_new_digital_product' => 'Ajouter un produit numérique',
        'todays_deal_updated_successfully' => 'L\'offre du jour a été mise à jour avec succès.',
        'product_approval_update_successfully' => 'Approbation du produit mise à jour avec succès.',
        'featured_products_updated_successfully' => 'Les produits vedettes ont été mis à jour avec succès.',
        'edit_digital_product' => 'Modifier le produit numérique',
        'product_file' => 'Fichier produit',

        // Barre intelligente (Smart Bar)
        'show_smart_bar' => 'Afficher la barre intelligente',
        'this_bar_will_show_a_product_summary_at_the_bottom_of_the_product_detail_page_while_scrolling' => 'Cette barre affiche un résumé du produit en bas de la page détail lors du défilement.',
        'select_background_design' => 'Sélectionner le style d\'arrière-plan',
        'plain' => 'Uni',
        'blur' => 'Flou',
        'select_background_color' => 'Sélectionner la couleur d\'arrière-plan',
        'select_text_color' => 'Sélectionner la couleur du texte',
        'light' => 'Clair',
        'select_button_color' => 'Sélectionner la couleur du bouton',
        'select_button_text_color' => 'Sélectionner la couleur du texte du bouton',
        'network_error' => 'Erreur réseau',
        'are_you_sure_you_want_to_set_this_smart_bar_in_product_detail_page' => 'Voulez-vous activer cette barre intelligente sur la page de détail ?',
        'are_you_sure_you_want_to_disable_this_smart_bar_in_product_detail_page' => 'Voulez-vous désactiver cette barre intelligente sur la page de détail ?',
        'customers_will_see_a_smart_bar_in_product_detail_page' => 'Les clients verront une barre intelligente sur la page de détail.',
        'customers_will_no_longer_see_smart_bar_in_product_detail_page' => 'Les clients ne verront plus la barre intelligente sur la page de détail.',
        'allow' => 'Autoriser',
        'disable' => 'Désactiver',

        // Étiquettes personnalisées
        'label' => 'Étiquette',
        'add_new_custom_label' => 'Ajouter une étiquette personnalisée',
        'seller_can_access' => 'Accessible aux vendeurs',
        'sellers_can_create_custom_label' => 'Les vendeurs peuvent créer des étiquettes personnalisées',
        'inhouse' => 'Interne',
        'are_you_sure_you_want_to_allow_sellers_to_create_custom_labels' => 'Voulez-vous autoriser les vendeurs à créer des étiquettes personnalisées ?',
        'are_you_sure_you_want_to_disable_custom_label_creation_for_sellers' => 'Voulez-vous désactiver la création d\'étiquettes pour les vendeurs ?',
        'sellers_will_be_able_to_create_their_own_custom_labels' => 'Les vendeurs pourront créer leurs propres étiquettes personnalisées.',
        'sellers_will_no_longer_be_able_to_create_custom_labels' => 'Les vendeurs ne pourront plus créer d\'étiquettes personnalisées.',
        'allow_sellers_to_create' => 'Autoriser les vendeurs à créer',
        'disable_for_sellers' => 'Désactiver pour les vendeurs',
        'are_you_sure_you_want_to_allow_this_custom_label_for_seller' => 'Voulez-vous autoriser cette étiquette personnalisée pour ce vendeur ?',
        'are_you_sure_you_want_to_close_this_custom_label_for_seller' => 'Voulez-vous fermer cette étiquette personnalisée pour ce vendeur ?',
        'sellers_will_be_able_to_use_this_custom_label_for_their_products' => 'Les vendeurs pourront utiliser cette étiquette pour leurs produits.',
        'sellers_will_no_longer_be_use_this_custom_label_for_their_products' => 'Les vendeurs ne pourront plus utiliser cette étiquette pour leurs produits.',
        'allow_sellers_to_use' => 'Autoriser les vendeurs à utiliser',
        'custom_label_seller_access_updated_successfully' => 'Accès vendeur à l\'étiquette mis à jour avec succès.',
        'edit_custom_label_information' => 'Modifier les informations de l\'étiquette',
        'update' => 'Mettre à jour',
        'choose_products' => 'Choisir des produits',
        ...
        'mark_featured' => 'Marquer comme vedette',
        'mark_hot' => 'Marquer comme populaire',
        'featured_categories_updated_successfully' => 'Catégories vedettes mises à jour avec succès.',
        'hot_categories_updated_successfully' => 'Catégories populaires mises à jour avec succès.',
        'selected_items_added_to_featured_categories_successfully' => 'Éléments ajoutés aux catégories vedettes avec succès.',
        'selected_items_added_to_hot_categories_successfully' => 'Éléments ajoutés aux catégories populaires avec succès.',

        // Attributs
        'all_attributes' => 'Tous les attributs',
        'add_new_attributes' => 'Ajouter des attributs',
        'values' => 'Valeurs',
        'are_you_sure_you_want_to_delete_this_attribute' => 'Êtes-vous sûr de vouloir supprimer cet attribut ?',
        'all_associated_attribute_values_will_also_be_permanently_deleted' => 'Toutes les valeurs associées seront également supprimées définitivement.',

        // Forfaits annonces classées
        'all_classifies_packages' => 'Tous les forfaits annonces',
        'add_new_package' => 'Ajouter un forfait',
        'package_logo' => 'Logo du forfait',
        'product_upload' => 'Import de produits',
        'update_package_information' => 'Mettre à jour les informations du forfait',
        'package_name' => 'Nom du forfait',
        'create_new_package' => 'Créer un forfait',

        // Clients
        'you_need_to_configure_smtp_correctly_to_to_add_customer_by_email' => 'Vous devez configurer SMTP correctement pour ajouter un client par e-mail.',
        'customer_information' => 'Informations client',
        'use_email_instead' => 'Utiliser l\'e-mail à la place',
        'confirm_password' => 'Confirmer le mot de passe',
        'use_phone_number_instead' => 'Utiliser le numéro de téléphone à la place',
        'add_new_customer' => 'Ajouter un client',
        'all_customers' => 'Tous les clients',
        'this_color_indicates_that_the_customer_is_marked_as_blocked' => 'Cette couleur indique que le client est marqué comme bloqué.',
        'this_color_indicates_that_the_customer_is_marked_as_suspicious' => 'Cette couleur indique que le client est marqué comme suspect.',
        'filter_by_verification_status' => 'Filtrer par statut de vérification',
        'unverified' => 'Non vérifié',
        'type_email_or_name_enter' => 'Saisir l\'e-mail ou le nom & Entrée',
        'package' => 'Forfait',
        'wallet_balance' => 'Solde du portefeuille',
        'verification_status' => 'Statut de vérification',
        'log_in_as_this_customer' => 'Se connecter en tant que ce client',
        'ban_this_customer' => 'Bannir ce client',
        'unban_this_customer' => 'Débannir ce client',
        'do_you_really_want_to_ban_this_customer' => 'Voulez-vous vraiment bannir ce client ?',
        'proceed' => 'Continuer',
        'do_you_really_want_to_unban_this_customer' => 'Voulez-vous vraiment débannir ce client ?',
        ...
        // Panier / Checkout
        'please_select_cart_items_to_proceed' => 'Veuillez sélectionner des articles pour continuer',
        'please_try_again_later' => 'Veuillez réessayer plus tard',
        'there_is_no_payment_option_is_selected' => 'Aucune option de paiement n\'est sélectionnée',
        'you_order_amount_is_less_than_the_minimum_order_amount' => 'Le montant de votre commande est inférieur au minimum requis',
        'your_cart_was_empty' => 'Votre panier était vide',
        ...
        'seller_message' => 'Message au vendeur',
        'subtotal' => 'Sous-total',
        'tax' => 'Taxe',
        'redeem_point' => 'Utiliser les points',
        'coupon_discount' => 'Réduction coupon',
        'change_coupon' => 'Changer le coupon',
        'have_coupon_code_apply_here' => 'Vous avez un code coupon ? Appliquez-le ici',
        'apply' => 'Appliquer',
        'qty' => 'Qté',
        'remove' => 'Supprimer',
        'total_clubpoint' => 'Total des points club',
        'off_on_total_orders' => 'de réduction sur les commandes',
        'off_on_total_orders_within' => 'de réduction sur les commandes dans',
        'days_of_registration' => 'jours après inscription',
        'copy_the_code' => 'Copier le code',
        'items' => 'Articles',
        ...
        'gst_amount' => 'Montant de la TVA',

        // Compte / Profil / Authentification
        'delete_account' => 'Supprimer le compte',
        'warning_you_cannot_undo_this_action' => 'Attention : cette action est irréversible',
        'dont_click_to_any_button_or_dont_do_any_action_during_account_deletion_it_may_takes_some_times' => 'Ne cliquez sur aucun bouton pendant la suppression du compte, cela peut prendre du temps.',
        'deleting_account_means' => 'La suppression du compte signifie :',
        'if_you_create_any_classified_ptoducts_after_deleting_your_account_those_products_will_no_longer_in_our_system' => 'Vos annonces classées seront définitivement supprimées.',
        'after_deleting_your_account_wallet_balance_will_no_longer_in_our_system' => 'Le solde de votre portefeuille sera également supprimé.',
        'your_profile_has_been_updated_successfully' => 'Votre profil a été mis à jour avec succès',
        'documents_submitted_successfully_please_wait_for_verification' => 'Documents soumis avec succès ! Vérification en cours.',
        'email_changed_successfully' => 'E-mail modifié avec succès',
        'email_was_not_verified_please_resend_your_mail' => 'E-mail non vérifié. Veuillez renvoyer votre e-mail.',
        'password_updated_successfully' => 'Mot de passe mis à jour avec succès',
        'verification_code_mismatch' => 'Code de vérification incorrect',
        'your_email_has_been_verified_successfully' => 'Votre e-mail a été vérifié avec succès',
        'sorry_we_could_not_verifiy_you_please_try_again' => 'Désolé, nous n\'avons pas pu vous vérifier. Réessayez.',
        'verification_code_sent_successfully' => 'Code de vérification envoyé avec succès',
        'verification_code_sending_failed' => 'Échec de l\'envoi du code de vérification',
        'verification_code_did_not_match' => 'Le code de vérification ne correspond pas',
        'verification_code_do_not_matched' => 'Le code de vérification ne correspond pas',
        'verification_successful' => 'Vérification réussie',
        'a_verification_mail_has_been_sent_to_the_new_email_address_you_provided' => 'Un e-mail de vérification a été envoyé à votre nouvelle adresse',
        'invalid_login_credentials' => 'Identifiants de connexion invalides',
        'invalid_email_or_password' => 'E-mail ou mot de passe invalide',
        'no_account_exists_with_this_email' => 'Aucun compte avec cet e-mail',
        'no_account_exists_with_this_phone_number' => 'Aucun compte avec ce numéro de téléphone',
        'your_otp_code_has_expired_please_request_a_new_one' => 'Votre code OTP a expiré. Demandez-en un nouveau.',
        'session_expired_please_try_again' => 'Session expirée. Veuillez réessayer.',
        'registration_successful' => 'Inscription réussie',
        'registration_successful_please_verify_your_email' => 'Inscription réussie. Vérifiez votre e-mail.',
        'registration_failed_please_try_again_later' => 'Échec de l\'inscription. Réessayez plus tard.',
        'this_email_domain_is_not_allowed_please_use_a_valid_email_address' => 'Ce domaine de messagerie n\'est pas autorisé.',
        'email_or_phone_already_exists' => 'L\'e-mail ou le numéro de téléphone existe déjà',
        ...
        'login_to_your_delivery_boy_account' => 'Connexion à votre espace livreur',

        // Page produit frontend
        'buy_now' => 'Acheter maintenant',
        'club_point' => 'Points club',
        'total_price' => 'Prix total',
        'sold_by' => 'Vendu par',
        'copy_the_promote_link' => 'Copier le lien promotionnel',
        'view_policy' => 'Voir la politique',
        'seller_guarantees' => 'Garanties du vendeur',
        'verified_seller' => 'Vendeur vérifié',
        'non_verified_seller' => 'Vendeur non vérifié',
        'customer_reviews' => 'Avis clients',
        'video' => 'Vidéo',
        'download' => 'Télécharger',
        'there_have_been_no_reviews_for_this_product_yet' => 'Aucun avis pour ce produit.',
        'write_your_question_here' => 'Écrivez votre question ici...',
        'my_questions' => 'Mes questions',
        'seller_did_not_respond_yet' => 'Le vendeur n\'a pas encore répondu',
        'to_submit_your_questions_to_seller' => 'pour soumettre votre question au vendeur',
        'ask_about_this_product' => 'Poser une question sur ce produit',
        'message_seller' => 'Contacter le vendeur',
        'no_related_products_found' => 'Aucun produit similaire trouvé',
        'contact_not_available' => 'Contact non disponible',
        'location' => 'Localisation',
        'people_are_viewing_right_now' => 'personnes consultent en ce moment',
        'download_product_specifation' => 'Télécharger la fiche produit',
        'selected_product_summery' => 'Résumé du produit sélectionné',
        'refund' => 'Remboursement',
        'available' => 'disponible(s)',
        'go_to_product_details_page' => 'Aller à la page du produit',

        // Recherche / Navigation frontend
        'sorry_nothing_found_for' => 'Désolé, rien trouvé pour',
        ...
        'view_all_brands' => 'Voir toutes les marques',
        ...
        'delete_confirmation_message' => 'Êtes-vous sûr de vouloir supprimer ?',

        // Notifications JS
        'item_has_been_removed_from_cart' => 'Article supprimé du panier',
        'item_has_been_added_to_compare_list' => 'Article ajouté à la comparaison',
        'item_has_been_added_to_wishlist' => 'Article ajouté aux favoris',
        'please_login_as_a_customer_to_add_products_to_the_wishlist' => 'Connectez-vous en tant que client pour ajouter aux favoris',
        'failed_to_load_stock_data' => 'Échec du chargement des données de stock',
        'please_login_as_a_customer_to_add_products_to_the_cart' => 'Connectez-vous en tant que client pour ajouter au panier',
        'please_choose_all_the_options' => 'Veuillez choisir toutes les options',
        'product_not_found' => 'Produit non trouvé',
        'stock_out' => 'Rupture de stock',
        'this_auction_product_is_alreday_added_to_cart' => 'Ce produit aux enchères est déjà dans le panier',
        'this_item_is_out_of_stock' => 'Cet article est en rupture de stock',
        'back_to_shopping' => 'Retour aux achats',
        'coupon_code_copied' => 'Code coupon copié',
        'ordered_just_now' => 'commandé à l\'instant',
        'sorry_only_customers_sellers_can_bid' => 'Désolé, seuls les clients et vendeurs peuvent enchérir.',
        'min_bid_amount' => 'Montant minimum d\'enchère',

        // Widget upload de fichiers
        'file_selected' => 'Fichier sélectionné',
        'files_selected' => 'Fichiers sélectionnés',
        'add_more_files' => 'Ajouter d\'autres fichiers',
        'adding_more_files' => 'Ajout de fichiers...',
        ...
        'resume_upload' => 'Reprendre',
        'pause_upload' => 'Mettre en pause',
        'retry_upload' => 'Réessayer',
        'cancel_upload' => 'Annuler le téléchargement',
        'uploading' => 'Téléchargement en cours',
        'complete' => 'Terminé',
        'ok_i_understood' => 'Ok, j\'ai compris',

        // Étapes checkout
        '1_my_cart' => '1. Mon panier',
        '2_shipping_info' => '2. Infos de livraison',
        '3_delivery_info' => '3. Mode de livraison',
        '4_payment' => '4. Paiement',
        '5_confirmation' => '5. Confirmation',

        // Livraison / Adresses
        'choose_delivery_type' => 'Choisir le type de livraison',
        'local_pickup' => 'Retrait en point relais',
        'select_your_nearest_pickup_point' => 'Sélectionnez le point de retrait le plus proche',
        'transit_in' => 'Transit en',
        'we_no_longer_deliver_in_this_area' => 'Nous ne livrons plus dans cette zone',
        'add_new_address' => 'Ajouter une nouvelle adresse',
        'add_new_billing_address' => 'Ajouter une adresse de facturation',
        'choose_billing_address' => 'Choisir l\'adresse de facturation',
        'address_is_not_valid' => 'Adresse invalide',
        'recharge_wallet' => 'Recharger le portefeuille',
        'select_state' => 'Sélectionner l\'État',
        'select_city' => 'Sélectionner la ville',
        'area_not_available' => 'Zone non disponible',
        'select_area' => 'Sélectionner la zone',

        // Paiement / OTP
        'payment_unsuccessful' => 'Paiement échoué',
        'payment_is_cancelled' => 'Paiement annulé',
        'payment_completed' => 'Paiement effectué',
        'otp_is_invalid' => 'Code OTP invalide',
        'otp_sent_to_your_phone_valid_for_10_minutes' => 'OTP envoyé. Valide 10 minutes.',
        ...
        'phone_no_optional' => 'Numéro de téléphone (optionnel)',
        'enter_phone' => 'Entrer le téléphone',
        'tell_us_about_your_query' => 'Décrivez votre question',
        'type_here' => 'Tapez ici...',
        'query_contact_reply' => 'Réponse à la demande de contact',
        'reply_has_been_sent_successfully' => 'La réponse a été envoyée avec succès',
        'query_contact' => 'Demande de contact',
        'query_has_been_sent_successfully' => 'La demande a été envoyée avec succès',
        'your_query_has_been_submittes_successfully' => 'Votre question a été soumise avec succès',

        // Comparaison / Wishlist
        'compare_products' => 'Comparer les produits',
        'reset_compare_list' => 'Réinitialiser la comparaison',
        'your_comparison_list_is_empty' => 'Votre liste de comparaison est vide',

        // Footer / Compte
        'order_history' => 'Historique des commandes',
        'my_wishlist' => 'Ma liste de souhaits',
        'track_order' => 'Suivre ma commande',
        'be_an_affiliate_partner' => 'Devenir partenaire affilié',
        'apply_now' => 'Postuler maintenant',
        'login_to_seller_panel' => 'Accès espace vendeur',
        'download_seller_app' => 'Télécharger l\'app vendeur',
        'download_delivery_boy_app' => 'Télécharger l\'app livreur',

        // Divers frontend / Controllers
        'address' => 'Adresse',
        'copy' => 'Copier',
        'share' => 'Partager',
        'variation' => 'Variation',
        'you_cannot_download_this_product' => 'Vous ne pouvez pas télécharger ce produit',
        'ticket_has_been_sent_successfully' => 'Le ticket a été envoyé avec succès',
        'support_ticket_code_is' => 'Le code du ticket de support est',
        'hi_a_ticket_has_been_created_please_check_the_ticket' => 'Bonjour. Un ticket a été créé. Veuillez le vérifier.',
        'product_copied_successfully_you_can_now_edit_and_save_your_new_product' => 'Produit copié. Vous pouvez maintenant le modifier.',
        'only_draft_products_can_be_automatically_saved_as_draft' => 'Seuls les brouillons peuvent être enregistrés automatiquement.',
        'draft_saved_successfully' => 'Brouillon enregistré avec succès',
        'failed_to_save_draft' => 'Échec de l\'enregistrement du brouillon',
        'please_configure_smtp_first' => 'Veuillez configurer le SMTP d\'abord',
        'newsletter_has_been_send' => 'La newsletter a été envoyée',
        'an_email_has_been_sent' => 'Un e-mail a été envoyé',
        'select_nearest_pickup_point' => 'Sélectionner le point de retrait le plus proche',
        'inhouse_products' => 'Produits de la boutique principale',
        'you_must_be_logged_in_to_access_this_invoice' => 'Vous devez être connecté pour accéder à cette facture',
        'you_do_not_have_the_right_permission_to_access_this_invoice' => 'Vous n\'avez pas la permission d\'accéder à cette facture',
        'no_payment_history_available_for_this_seller' => 'Aucun historique de paiement pour ce vendeur',
        'withdrawal_request_submitted_successfully' => 'Demande de retrait soumise avec succès',
        'minimum_withdrawal_amount_is' => 'Le montant minimum de retrait est',
        'your_shop_is_not_verified_yet' => 'Votre boutique n\'est pas encore vérifiée',
        'your_shop_has_been_updated_successfully' => 'Votre boutique a été mise à jour avec succès',
        'your_shop_banners_has_been_updated_successfully' => 'Les bannières de votre boutique ont été mises à jour',
        'sorry_you_have_sent_verification_request_already' => 'Vous avez déjà envoyé une demande de vérification',

        // --- Sales / Commandes ---
        'order_details' => 'Détails de la commande',
        'assign_deliver_boy' => 'Assigner un livreur',
        'select_delivery_boy' => 'Sélectionner un livreur',
        'confirmed' => 'Confirmée',
        'shipping_system' => 'Système d\'expédition',
        'select_shipping_system' => 'Sélectionner le système d\'expédition',
        'shiprocket_order_status' => 'Statut commande Shiprocket',
        'shiprocket_delivery_status' => 'Statut livraison Shiprocket',
        'steadfast_status' => 'Statut Steadfast',
        'steadfast_consignment_id' => 'ID consignation Steadfast',
        'pathao_status' => 'Statut Pathao',
        'pathao_consignment_id' => 'ID consignation Pathao',
        'courier' => 'Transporteur',
        'request_pickup' => 'Demander une collecte',
        'pickup_scheduled' => 'Collecte planifiée',
        'awb_code' => 'Code AWB',
        'steadfast_tracking_code' => 'Code de suivi Steadfast',
        'pathao_delivery_fee' => 'Frais de livraison Pathao',
        'payment_information' => 'Informations de paiement',
        'trx_id' => 'ID transaction',
        'total_amount' => 'Montant total',
        'shipping' => 'Expédition',
        'sub_total' => 'Sous-total',
        'total_gst' => 'Total TVA',
        'na' => 'N/D',
        'would_you_like_to_assign_a_courier_and_generate_the_awb_code_for_this_order' => 'Souhaitez-vous assigner un transporteur et générer le code AWB pour cette commande ?',
        'would_you_like_to_request_a_pickup_for_this_order_the_courier_will_be_notified_upon_confirmation' => 'Souhaitez-vous demander une collecte ? Le transporteur sera notifié à la confirmation.',
        'confirm_pickup' => 'Confirmer la collecte',
        'would_you_like_to_create_this_order_in_steadfast_courier' => 'Souhaitez-vous créer cette commande dans Steadfast Courier ?',
        'select_store_name' => 'Sélectionner le nom de la boutique',
        'delivery_boy_has_been_assigned' => 'Le livreur a été assigné',
        'delivery_status_has_been_updated' => 'Le statut de livraison a été mis à jour',
        'payment_status_has_been_updated' => 'Le statut de paiement a été mis à jour',
        'order_tracking_code_has_been_updated' => 'Le code de suivi de la commande a été mis à jour',
        'no_location' => 'Aucune localisation',
        'no_pickup_address_found' => 'Aucune adresse de collecte trouvée',
        'box_size_length_breadth_height' => 'Taille de boîte (L × l × H)',
        'no_box_sizes_found' => 'Aucune taille de boîte trouvée',
        'failed_to_load_shipping_information' => 'Échec du chargement des informations d\'expédition',
        'please_select_pickup_address_and_box_size' => 'Veuillez sélectionner l\'adresse de collecte et la taille de la boîte',
        'select_courier' => 'Sélectionner le transporteur',
        'please_select_a_courier_first' => 'Veuillez d\'abord sélectionner un transporteur',
        'store_name' => 'Nom de la boutique',
        'no_store_found' => 'Aucune boutique trouvée',
        'please_select_store' => 'Veuillez sélectionner une boutique',
        'filter_by_order_type' => 'Filtrer par type de commande',
        'filter_by_date' => 'Filtrer par date',
        'type_order_code_hit_enter' => 'Saisir le code commande & Entrée',
        'num_of_products' => 'Nb de produits',
        'shiprocket_order_id' => 'ID commande Shiprocket',
        'inhouse_order' => 'Commande interne',
        'no_refund' => 'Aucun remboursement',
        'thermal_printer' => 'Imprimante thermique',
        'download_invoice' => 'Télécharger la facture',
        'are_you_sure_to_send_notification_for_the_selected_orders' => 'Êtes-vous sûr d\'envoyer une notification pour les commandes sélectionnées ?',
        'send_notification' => 'Envoyer la notification',
        'please_select_order_first' => 'Veuillez d\'abord sélectionner une commande',

        // --- Sellers / Vendeurs ---
        'you_need_to_configure_smtp_correctly_to_to_add_seller' => 'Vous devez configurer le SMTP correctement pour ajouter un vendeur',
        'add_new_seller' => 'Ajouter un nouveau vendeur',
        'shop_name' => 'Nom de la boutique',
        'pending_seller_list' => 'Liste des vendeurs en attente',
        'type_name_or_email_or_mobile_number_enter' => 'Nom, e-mail ou téléphone & Entrée',
        'registration_date' => 'Date d\'inscription',
        'access_approval' => 'Validation de l\'accès',
        'not_submitted' => 'Non soumis',
        'submitted' => 'Soumis',
        'view_info' => 'Voir les infos',
        'customer_documents' => 'Documents client',
        'unverified_sellers_verified_successfully' => 'Vendeurs non vérifiés validés avec succès',
        'pending_sellers_approved_successfully' => 'Vendeurs en attente approuvés avec succès',
        'approved_sellers_updated_successfully' => 'Vendeurs approuvés mis à jour avec succès',
        'tax_identification_document' => 'Document d\'identification fiscale',
        ...
        'due_to_admin' => 'Dû à l\'administrateur',
        'clear_due' => 'Solder le dû',
        'payment_details' => 'Détails du paiement',
        'about' => 'À propos',
        'payout_info' => 'Infos de versement',
        'bank_acc_name' => 'Nom du compte bancaire',
        'bank_acc_number' => 'Numéro du compte bancaire',
        'total_orders' => 'Total des commandes',
        'total_sold_amount' => 'Montant total vendu',
        'seller_payments' => 'Paiements vendeurs',
        'sellers_review_followers' => 'Avis & abonnés vendeurs',
        'set_bulk_commission' => 'Définir la commission en masse',
        'filter_by_approval' => 'Filtrer par approbation',
        'contact' => 'Contact',
        'seller_verification' => 'Vérification vendeur',
        'verification_approval' => 'Approbation de vérification',
        'followers' => 'Abonnés',
        'custom_followers' => 'Abonnés personnalisés',
        'suspicious' => 'Suspect',
        'regular' => 'Normal',
        'applied' => 'Candidat',
        'by_admin' => 'Par l\'administrateur',
        'not_applied' => 'Non candidat',
        'nonapproved' => 'Non approuvé',
        'profile' => 'Profil',
        'log_in_as_this_seller' => 'Se connecter en tant que ce vendeur',
        'go_to_payment' => 'Aller au paiement',
        'ban_this_seller' => 'Bannir ce vendeur',
        'unban_this_seller' => 'Débannir ce vendeur',
        'ban' => 'Bannir',
        'mark_as_unsuspect' => 'Marquer comme non suspect',
        'mark_as_suspicious' => 'Marquer comme suspect',
        'do_you_really_want_to_ban_this_seller' => 'Voulez-vous vraiment bannir ce vendeur ?',
        'do_you_really_want_to_unban_this_seller' => 'Voulez-vous vraiment débannir ce vendeur ?',
        'please_select_seller_first' => 'Veuillez d\'abord sélectionner un vendeur',
        'edit_custom_follower' => 'Modifier les abonnés personnalisés',
        'edit_seller_custom_followers' => 'Modifier les abonnés personnalisés du vendeur',
        'set_category_wise_commission' => 'Définir la commission par catégorie',
        'commission_type_is_not_category_based_set_commission_type' => 'Le type de commission n\'est pas par catégorie, définir le type de commission',
        'seller_commission_is_not_activated_active' => 'La commission vendeur n\'est pas activée, activer',
        'type_name_enter' => 'Saisir le nom & Entrée',
        'icon' => 'Icône',
        'commission_rate' => 'Taux de commission',
        'are_you_sure_you_want_to_set_this_category_wise_commission' => 'Êtes-vous sûr de vouloir définir cette commission par catégorie ?',
        'commission_can_not_be_less_than_0' => 'La commission ne peut pas être inférieure à 0',
        'category_wise_commission_set_successfully' => 'Commission par catégorie définie avec succès',
        'set_seller_based_commission' => 'Définir la commission par vendeur',
        'commission_type_is_not_seller_based_set_commission_type' => 'Le type de commission n\'est pas par vendeur, définir le type de commission',
        'are_you_sure_you_want_to_set_this_seller_based_commission' => 'Êtes-vous sûr de vouloir définir cette commission par vendeur ?',
        'seller_based_commission_set_successfully' => 'Commission par vendeur définie avec succès',
        'select_label' => 'Sélectionner un libellé',
        'text_input' => 'Champ texte',
        'multiple_select_label' => 'Libellé sélection multiple',
        'radio_label' => 'Libellé radio',
        'seller_commission_activatation' => 'Activation de la commission vendeur',
        'commission_type' => 'Type de commission',
        'fixed_commission_rate' => 'Taux de commission fixe',
        'seller_based_commission_rate' => 'Taux de commission par vendeur',
        'category_based_commission_rate' => 'Taux de commission par catégorie',
        'withdraw_seller_amount' => 'Retrait du montant vendeur',
        'minimum_seller_amount_withdraw' => 'Montant minimum de retrait vendeur',
        'note' => 'Note',
        'if_the_commission_type_is_fixed_rate' => 'Si le type de commission est Taux fixe',
        'of_seller_product_price_will_be_deducted_from_seller_earnings' => 'du prix produit vendeur sera déduit des gains du vendeur',
        'if_the_commission_type_is_seller_based_set_commission_percentage' => 'Si le type de commission est Par vendeur, définir le pourcentage',
        'if_the_commission_type_is_category_based_set_commission_percentage' => 'Si le type de commission est Par catégorie, définir le pourcentage',
        'print' => 'Imprimer',
        ...
        'last_purchase_date' => 'Dernière date d\'achat',
        'duplicate' => 'Dupliquer',
        'user_info' => 'Infos utilisateur',
        'shop_info' => 'Infos boutique',
        'verification_info' => 'Infos de vérification',
        'total_orders_received' => 'Total des commandes reçues',
        'total_delivered_orders' => 'Total des commandes livrées',
        'total_pending_orders' => 'Total des commandes en attente',
        'commission_paid_to_platform' => 'Commission payée à la plateforme',
        'total_withdrawn_amount' => 'Montant total retiré',
        'last_payout_date' => 'Dernière date de versement',
        'pending_withdrawal_request' => 'Demande de retrait en attente',
        'view_submitted_form' => 'Voir le formulaire soumis',
        ...
        'current_seller_balance' => 'Solde actuel du vendeur',

        // --- Support / Tickets ---
        'type_your_reply' => 'Saisir votre réponse',
        'submit_as' => 'Soumettre comme',
        'open' => 'Ouvert',
        'solved' => 'Résolu',
        'type_ticket_code_enter' => 'Saisir le code ticket & Entrée',
        'ticket_id' => 'ID ticket',
...
// ── Moov Money OTP Payment ──────────────────────────────────────────────────

if (!function_exists('moovFormatPhone')) {
    function moovFormatPhone(string $phone): string
    {
        $cleaned = preg_replace('/\D/', '', $phone);
        if (substr($cleaned, 0, 3) === '226') return $cleaned;
        if (strlen($cleaned) === 9 && $cleaned[0] === '0') return '226' . substr($cleaned, 1);
        return '226' . $cleaned;
    }
}

if (!function_exists('moovRequest')) {
    function moovRequest(string $commandId, array $body): ?object
    {
...
// Étape 1 : génère l'OTP et l'envoie par SMS au client.
// Retourne ['request_id' => string, 'response' => object|null]
if (!function_exists('moovGenerateOtp')) {
    function moovGenerateOtp(int $amount, string $phone): array
    {
        $requestId = 'DAKWARI-' . uniqid();
        $response  = moovRequest('process-create-mror-otp', [
            'request-id'    => $requestId,
            'destination'   => moovFormatPhone($phone),
            'amount'        => $amount,
            'remarks'       => 'OTP Merchant',
            'extended-data' => ['module' => 'MERCHOTPPAY'],
        ]);
        return ['request_id' => $requestId, 'response' => $response];
    }
}

// Étape 1b (optionnel) : renvoie l'OTP.
if (!function_exists('moovResendOtp')) {
    function moovResendOtp(int $amount, string $phone, string $originalRequestId): array
    {
        $requestId = 'DAKWARI-RESEND-' . uniqid();
        $response  = moovRequest('process-mror-resend-otp', [
            'request-id'    => $requestId,
            'destination'   => moovFormatPhone($phone),
            'amount'        => $amount,
            'remarks'       => 'RESEND OTP',
            'extended-data' => ['module' => 'MERCHOTPPAY', 'ext1' => $originalRequestId],
        ]);
        return ['request_id' => $requestId, 'response' => $response];
    }
}

// Étape 2 : valide le paiement avec l'OTP saisi par le client.
if (!function_exists('moovCommitPayment')) {
    function moovCommitPayment(int $amount, string $phone, string $otp, string $transId, string $originalRequestId): ?object
    {
        return moovRequest('process-commit-otppay', [
            'request-id'    => 'COMMIT-' . uniqid(),
            'destination'   => moovFormatPhone($phone),
            'amount'        => $amount,
