...
function get_french_translations_fallback()
{
    return [
        ...
        // Module retrait livreur
        'Delivery Boy Withdrawal Requests' => 'Demandes de retrait des livreurs',
        ...
        'No withdrawal requests found.' => 'Aucune demande de retrait.',
        'Approve Withdrawal?' => 'Approuver le retrait ?',
        'Approve withdrawal of' => 'Approuver le retrait de',
        'for' => 'pour',
        'Mark as Paid' => 'Marquer comme payé',
        'Confirm that you have paid' => 'Confirmez que vous avez payé',
        'to' => 'à',
        'Reject Withdrawal Request' => 'Rejeter la demande de retrait',
        'Reason for Rejection' => 'Motif du rejet',
        'Explain why this request is rejected...' => 'Expliquez pourquoi cette demande est rejetée...',
        'Withdrawal Request Details' => 'Détail de la demande de retrait',
        'Requested Amount' => 'Montant demandé',
        'Account Number' => 'Numéro de compte',
        'Request Date' => 'Date de demande',
        'Message' => 'Message',
        'Current Earning Balance' => 'Solde de gains actuel',
        'Insufficient balance' => 'Solde insuffisant',
        'Rejection Reason' => 'Motif du rejet',
        'Payment Note' => 'Note de paiement',
        'Admin Note' => 'Note admin',
        'optional' => 'optionnel',
        'e.g. Transferred via Orange Money #TXN123' => 'ex. Transféré via Orange Money #TXN123',
        'Withdrawal request approved.' => 'Demande de retrait approuvée.',
        'Payment confirmed successfully.' => 'Paiement confirmé avec succès.',
        'Withdrawal request rejected.' => 'Demande de retrait rejetée.',
        'This request is no longer pending.' => 'Cette demande n\'est plus en attente.',
        'Only approved requests can be confirmed as paid.' => 'Seules les demandes approuvées peuvent être confirmées.',
        'Insufficient balance for this withdrawal.' => 'Solde insuffisant pour ce retrait.',
        'Insufficient balance. The earning may have changed.' => 'Solde insuffisant. Les gains ont peut-être changé.',
        'Delivery boy not found.' => 'Livreur introuvable.',
        'This request cannot be rejected.' => 'Cette demande ne peut pas être rejetée.',
        'Search by name or phone' => 'Rechercher par nom ou téléphone',
        'pending count' => 'en attente',
        'Minimum Withdrawal Amount' => 'Montant minimum de retrait',
        'Minimum amount a delivery boy can request to withdraw.' => 'Montant minimum qu\'un livreur peut demander à retirer.',
        'Cash' => 'Espèces',
        'Close' => 'Fermer',
        'Cancel' => 'Annuler',
    ];
